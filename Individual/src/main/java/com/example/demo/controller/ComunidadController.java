...
import com.example.demo.service.ComunidadServiceImpl;
	...
	public class ComunidadController {
		...
		public ResponseEntity<List<Comunidad>> getAllComunidades() {
			return new ResponseEntity<>(comunidadServiceImpl.getComunidad(), HttpStatus.OK);
		}
		...
		public ResponseEntity<?> postComunidad(@RequestBody Comunidad comunidad) {
			...
			if (newComunidad == null) {
				response.put("mensaje", "La comunidad: " + comunidad.getNombre() + " no se ha guardado en la base de datos");
